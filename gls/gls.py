...
def merge_saif(app):
    ...
    prefix = f"set power_enable_analysis true; read_verilog testbench.sv; set target_library {stdcell_file[:-2]}.db; set link_path \"* $target_library\"; current_design testbench"
