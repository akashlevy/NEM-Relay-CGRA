...
def merge_saif(app):
    ...
    prefix = f"set power_enable_analysis true; read_verilog {design_file}; set target_library {stdcell_file}; set link_path \"* $target_library\"; current_design {tile_module}"
