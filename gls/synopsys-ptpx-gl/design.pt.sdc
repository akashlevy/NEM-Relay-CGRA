...
#  Generated on:      Tue Apr 13 12:22:32 2021
...
set_clock_latency -source -early -min -rise  -0.149786 [get_ports {clk_in}] -clock ideal_clock 
set_clock_latency -source -early -min -fall  -0.132425 [get_ports {clk_in}] -clock ideal_clock 
set_clock_latency -source -early -max -rise  -0.149786 [get_ports {clk_in}] -clock ideal_clock 
set_clock_latency -source -early -max -fall  -0.132425 [get_ports {clk_in}] -clock ideal_clock 
set_clock_latency -source -late -min -rise  -0.149786 [get_ports {clk_in}] -clock ideal_clock 
set_clock_latency -source -late -min -fall  -0.132425 [get_ports {clk_in}] -clock ideal_clock 
set_clock_latency -source -late -max -rise  -0.149786 [get_ports {clk_in}] -clock ideal_clock 
set_clock_latency -source -late -max -fall  -0.132425 [get_ports {clk_in}] -clock ideal_clock 
