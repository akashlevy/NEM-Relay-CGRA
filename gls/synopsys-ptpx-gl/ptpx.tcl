...
report_activity_file_check $ptpx_saif -strip_path $ptpx_strip_path \
  > reports/$appdesname.activity.pre.rpt
...
check_constraints -verbose \
  > reports/$appdesname.checkconstraints.rpt

read_parasitics -format spef $ptpx_spef

report_annotated_parasitics -check \
  > reports/$appdesname.parasitics.rpt
...
check_power \
  > reports/$appdesname.checkpower.rpt
...
report_switching_activity \
  > reports/$appdesname.activity.post.rpt
