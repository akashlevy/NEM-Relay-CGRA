...
###########################################################
if {[::legacy::find -design /designs/pe_tile_new_unq1] ne ""} {
  puts "** A design with the same name is already loaded. It will be removed. **"
  delete_obj /designs/pe_tile_new_unq1
}
...
# Design
###########################################################
read_netlist -top pe_tile_new_unq1 results_syn/syn_out.v
...
# slack
set _slk_ [::legacy::get_attribute slack /designs/pe_tile_new_unq1]
if {[regexp {^-?[0-9.]+$} $_slk_]} {
...
# multi-mode slack
# tns
set _tns_ [::legacy::get_attribute tns /designs/pe_tile_new_unq1]
if {[regexp {^-?[0-9.]+$} $_tns_]} {
...
unset _tns_
# cell area
set _cell_area_ [::legacy::get_attribute cell_area /designs/pe_tile_new_unq1]
if {[regexp {^-?[0-9.]+$} $_cell_area_]} {
  set _cell_area_ [format %.0f $_cell_area_]
}
if {$_cell_area_ != "3991"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 3991,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
set _net_area_ [::legacy::get_attribute net_area /designs/pe_tile_new_unq1]
if {[regexp {^-?[0-9.]+$} $_net_area_]} {
  set _net_area_ [format %.0f $_net_area_]
}
if {$_net_area_ != "1602"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 1602,  current net area: $_net_area_"
}
unset _net_area_
